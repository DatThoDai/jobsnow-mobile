...
import { StyleSheet, View, ScrollView, ActivityIndicator, Animated, Pressable, Image, Platform, ImageBackground, Modal, TouchableOpacity, TextInput, Alert } from 'react-native';
...
export function CompanyDetailScreen() {
  ...
  const handleReview = () => {
    Alert.alert('Viết đánh giá', 'Tính năng đang được phát triển để đồng bộ với Web.');
  };
      ...
      >
        <View style={styles.infoCard}>
          ...
          <View style={styles.actionRow}>
            ...
            <Pressable style={styles.reviewBtn} onPress={handleReview}>
              <Feather name="edit-3" color={colors.white} size={20} />
              <AppText variant="caption" color="white" style={{ fontWeight: '700' }}>Review</AppText>
            </Pressable>
          </View>
        </View>
              ...
              <Pressable key={job.jobId} style={styles.jobCard} onPress={() => navigation.navigate('JobDetail', { jobId: job.jobId })}>
                <View style={styles.jobCardTop}>
                  <View style={styles.jobCardInfo}>
                    <AppText variant="h4" numberOfLines={1}>{job.title}</AppText>
            ...
            reviews.map(review => (
              <View key={review.reviewId} style={styles.reviewCard}>
                ...
                <View style={styles.reviewDetails}>
                  ...
                  {review.content && (
                    <View style={styles.detailItem}>
                      <AppText variant="caption" color="textMuted" style={{ fontWeight: '700' }}>Nội dung:</AppText>
                      <AppText variant="bodySm" color="textSecondary" style={{ marginTop: 2 }}>{review.content}</AppText>
                    </View>
                  )}
                </View>
...
const styles = StyleSheet.create({
  ...
  headerRow: { flexDirection: 'row', paddingTop: 50, paddingHorizontal: spacing.lg },
  headerBtn: {
  ...
  infoCard: {
    ...
    borderWidth: 1, borderColor: 'rgba(0,0,0,0.03)', ...shadows.md,
  },
  ...
  reviewBtn: {
    paddingHorizontal: spacing.lg, height: 48, borderRadius: radius.lg,
